...
//     { id: '4', name: 'Aarav', role: 'Cleaning', lastVisit: '2025-07-01 / 4:30 PM', image: require('../assets/icon/humanicon.png') },
//     { id: '5', name: 'Meera', role: 'Security', lastVisit: '2025-06-28 / 4:30 PM', image: require('../assets/icon/humanicon.png') },
//     { id: '6', name: 'Aarav', role: 'Laundry', lastVisit: '2025-07-03 / 4:30 PM', image: require('../assets/icon/humanicon.png') },
//     { id: '7', name: 'Meera', role: 'Consulting', lastVisit: '2025-07-02 / 4:30 PM', image: require('../assets/icon/humanicon.png') },
//   ];
...
//               {['A-101', 'A-208', 'A-208', 'A-101', 'A-208'].map((flat, index) => (
...
//   {/* <TouchableOpacity onPress={() => removeStaff(staff.id)}>
//     <Image
...
//           onConfirm={() => confirmDelete(selectedStaffId)}
...
//   card: {
//      backgroundColor: '#F5FBFF',  alignItems: 'center',
//     shadowColor: '#ccc', shadowOpacity: 0.2, shadowOffset: { width: 1, height: 3 }, shadowRadius: 5,
//     elevation: 3, minHeight: 300, height: 780,
//   },
//   image: { marginTop: 170, width: 300, height: 300, marginBottom: 20 },
//   subtitle: { fontSize: 18, color: '#263238', textAlign: 'center', lineHeight: 18 },
//   fab: {
//     position: 'absolute', right: 20, bottom: 90, backgroundColor: '#ff9100',
//     width: 56, height: 56, borderRadius: 28, justifyContent: 'center', alignItems: 'center', elevation: 4,
//   },
//   footerContainer: { marginBottom: 50 },
//   searchInput: {
//     borderWidth: 1, borderColor: '#ccc', borderRadius: 25,
//     paddingVertical: 8, paddingHorizontal: 16, fontSize: 16, marginBottom: 12, color: '#000',
//   },
//   addNewCard: {
...
//   staffItem: {
//     flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', padding: 12,
//     borderRadius: 12, marginBottom: 12, shadowColor: '#000',
//     shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.2,
//     shadowRadius: 4, elevation: 3, height: 70, justifyContent: 'space-between',
//   },
//   staffRow: { flexDirection: 'row', alignItems: 'center' },
//   staffImage: { width: 50, height: 50, marginRight: 15, marginLeft: 10, marginTop: 10 },
...
//   assignedCard: {
//     width: 350, backgroundColor: '#fff', borderRadius: 12, marginBottom: 12, height: 100,
//     shadowColor: '#000', shadowOffset: { width: 0, height: 2 },
//     shadowOpacity: 0.2, shadowRadius: 4, elevation: 3, padding: 10,
//   },
...
//   callIcon: { width: 24, height: 24, marginRight: 20,marginBottom:'20' },
//  trashContainer: {
//   width: 95,
//   height: 35,
//   // alignSelf: 'flex-end',
...
//   profileCard: {
//     marginTop: 20, backgroundColor: '#fff', borderRadius: 12, padding: 20, alignItems: 'center',
//     shadowColor: '#000', shadowOffset: { width: 0, height: 2 },
//     shadowOpacity: 0.2, shadowRadius: 4, elevation: 3, width: '100%',
//   },
...
//   tagContainer: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', marginTop: 10 },
//   tag: {
//     borderWidth: 1, borderColor: '#007bff', borderRadius: 6,
//     paddingHorizontal: 10, paddingVertical: 6, margin: 4,
//   },
//   tagText: { color: '#007bff' },
//   buttonContainer: { flexDirection: 'row', justifyContent: 'space-around', width: '100%', marginTop: 15 },
//   button: { backgroundColor: '#007bff', paddingVertical: 8, paddingHorizontal: 18, borderRadius: 6 },
//   btnText: { color: '#fff' },
...
//       {/* 👇 Calendar Modal from Top with fade */}
//     {showCalendar && (
...
//   image: { marginTop: 170, width: 300, height: 300, marginBottom: 20 },
//   subtitle: { fontSize: 18, color: '#263238', textAlign: 'center', lineHeight: 24, marginHorizontal: 20 },
//   fab: {
//     position: 'absolute', right: 20, bottom: 90, backgroundColor: '#ff9100',
//     width: 56, height: 56, borderRadius: 28, justifyContent: 'center', alignItems: 'center', elevation: 4,
//   },
//   searchInput: {
//     borderWidth: 1, borderColor: '#ccc', borderRadius: 25,
//     paddingVertical: 8, paddingHorizontal: 16, fontSize: 16, marginBottom: 12, color: '#000', backgroundColor: '#fff',
//   },
//   addNewCard: {
//     flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', padding: 12,
//     borderRadius: 12, marginBottom: 12, shadowColor: '#000', shadowOffset: { width: 0, height: 2 },
...
//   },
//   staffRow: { flexDirection: 'row', alignItems: 'center' },
//   staffImage: { width: 50, height: 50, marginRight: 15, marginLeft: 10, marginTop: 5, borderRadius: 25 },
//   staffName: { fontWeight: '600', fontSize: 16, color: '#000' },
//   staffRole: { fontSize: 14, color: '#777' },
//   lastVisit: { fontSize: 12, color: '#555' },
//   checkIcon: { width: 20, height: 20, marginRight: 10 },
...
//     width: 350, backgroundColor: '#fff', borderRadius: 12, marginBottom: 12, height: 100,
//     shadowColor: '#000', shadowOffset: { width: 0, height: 2 },
//     shadowOpacity: 0.2, shadowRadius: 4, elevation: 3, padding: 10, justifyContent: 'space-between',
//   },
//   assignedRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
//   assignedLeft: { flexDirection: 'row', alignItems: 'center' },
...
//     marginTop: 20, backgroundColor: '#fff', borderRadius: 12, padding: 20, alignItems: 'center',
//     shadowColor: '#000', shadowOffset: { width: 0, height: 2 },
//     shadowOpacity: 0.2, shadowRadius: 4, elevation: 3, width: '90%',
//   },
//   avatar: { width: 100, height: 100, borderRadius: 50, marginBottom: 10 },
